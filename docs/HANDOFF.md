...
- Whether the new Facebook/Messenger in-app browser hint is clear enough without distracting from the session, and whether the tester can actually find an external-browser option in the Meta menu.
